// 8×8 bitmap font for printable ASCII 0x20..=0x7F (96 glyphs).
// Each entry is 8 bytes — one per pixel row, MSB = leftmost pixel.
// Rendered at 2× vertical scale → effective 8×16 character cells.
pub const FONT: [[u8; 8]; 96] = [
    ...
    /* 0x32 '2' */ [0x78,0xCC,0x0C,0x38,0x60,0xC4,0xFC,0x00],
